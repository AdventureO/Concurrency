...
# Calculate standard deviation for point (experiment)
def calculate_standard_deviation(result, cursor):
...
# Calculate standard deviation for all points (experiments)
def calculate_all_st_deviation(result, cursor):
    return [calculate_standard_deviation(i, cursor) for i in result]